...
pandoc -f markdown_github -t epub --toc -o InformacamGuide.epub metadata.yaml About.txt chapter1.txt chapter2.txt chapter3.txt chapter4.txt chapter5.txt chapter6.txt chapter7.txt chapter8.txt chapter9.txt chapter10.txt chapter11.txt
